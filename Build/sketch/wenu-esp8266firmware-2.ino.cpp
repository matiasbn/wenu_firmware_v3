...
void loop(void){
  ...
  // time_t now;
  // Serial.println(gmtime(&now));
  //Loop para ntp
  // if(!ntpSynced){
  //   ntpSynced = syncNTP();
  // }
  // else{
  //   Serial.println("Ya sincrozado");
  // }
  
}

#line 1 "/Users/matiasbarrios/Desktop/wenu-esp8266firmware-2/ntp_synccc.ino"
/********************
- www.geekstips.com
...
char ssid[] = "EngieFactory";  //  your network SSID (name)
char pass[] = "3ng135855";       // your network password
